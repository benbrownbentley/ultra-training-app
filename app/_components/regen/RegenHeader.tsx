...
// Top chrome on the regen screens. Back link is hidden on the Generating
// and Accepted states (both are transient and shouldn't be interruptible
// with a casual back tap).
export function RegenHeader({ hideBack }: { hideBack?: boolean }) {
  return (
